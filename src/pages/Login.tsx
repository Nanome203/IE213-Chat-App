...
function Login() {
    return (
        <div className="relative flex justify-center items-center h-screen w-screen" style={{ backgroundImage: `url(${bgLogin})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
            <div
                className="relative px-4 py-10 bg-white/50 bg-blur-md p-5 mx-8 md:mx-0 shadow rounded-3xl sm:p-10 h-fit"
            >
